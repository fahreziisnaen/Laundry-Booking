                        ...
                        <div class="flex items-center justify-between w-full">
                            ...
                            <div class="flex items-center space-x-4">
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(route('dashboard')); ?>" class="text-base font-medium text-gray-500 hover:text-gray-900">
                                        Dashboard
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                                        Masuk
                                    </a>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="mt-16">
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <a href="<?php echo e(route('bookings.check')); ?>" 
...
<?php /**PATH D:\Private Project\programmping\laravel\laundry\resources\views/welcome.blade.php ENDPATH**/ ?>